...
import com.vaadin.boot.Customer;
import com.vaadin.boot.CustomerEditor;
import com.vaadin.boot.CustomerRepository;
import com.vaadin.boot.VaadinUI;
...
public class VaadinUITests {
	...
	public void shouldFillOutTheGridWithNewData() {
		...
		customerDataWasFilled(editor, "Manoj", "Krishnamurthy");
		...
		then(getCustomersInGrid().get(getCustomersInGrid().size() - 1))
			...
			.containsExactly("Manoj", "Krishnamurthy");
	...
	public void shouldFilterOutTheGridWithTheProvidedLastName() {
		this.vaadinUI.init(this.vaadinRequest);
		this.repository.save(new Customer("Martin", "Fowler"));

		vaadinUI.listCustomers("Fowler");
	...
	static class Config {
		...
		public void initializeData() {
			this.repository.save(new Customer("Manoj", "Krishnamurthy"));
			this.repository.save(new Customer("Manoj_2", "Krishnamurthy"));
			this.repository.save(new Customer("Eleni", "Lialiamou"));
			this.repository.save(new Customer("Hong", "Zhou"));
			this.repository.save(new Customer("Simor", "Lowry"));
			this.repository.save(new Customer("Nash", "Pal"));
		}
	}
}
